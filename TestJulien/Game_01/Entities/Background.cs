...
namespace TestJulien.Game_01.Entities
{
    public sealed class Background : Entity, IUpdatable, IRenderable
    {
        ...
        public Background(Camera camera)
        {
            ...
            m_backgroundTexture_01 = Texture2D.Load(typeof(Background).Assembly.GetManifestResourceStream("TestJulien.Game_01.Textures.Background_01.png"));
            ...
            m_backgroundTexture_02 = Texture2D.Load(typeof(Background).Assembly.GetManifestResourceStream("TestJulien.Game_01.Textures.Background_02.png"));
