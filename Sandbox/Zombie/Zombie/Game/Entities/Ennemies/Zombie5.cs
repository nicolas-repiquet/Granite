    ...
    public class Zombie5 : Ennemy
    {
        ...
        public Zombie5()
        {
            m_walkRightSequence = new SpriteSequence(
                EnnemiesSprites.Instance.Z5Right1,
                EnnemiesSprites.Instance.Z5Right2,
                EnnemiesSprites.Instance.Z5Right3
            );

            m_walkLeftSequence = new SpriteSequence(
               EnnemiesSprites.Instance.Z5Left1,
               EnnemiesSprites.Instance.Z5Left2,
               EnnemiesSprites.Instance.Z5Left3
           );

            m_walkFrontSequence = new SpriteSequence(
                EnnemiesSprites.Instance.Z5Front1,
                EnnemiesSprites.Instance.Z5Front2,
                EnnemiesSprites.Instance.Z5Front3
            );

            m_walkBackSequence = new SpriteSequence(
                EnnemiesSprites.Instance.Z5Back1,
                EnnemiesSprites.Instance.Z5Back2,
                EnnemiesSprites.Instance.Z5Back3
            );
        ...
        {
            m_sprite = renderer.AddSprite(EnnemiesSprites.Instance.Z5Front1);
        }
