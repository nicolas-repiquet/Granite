...
namespace Granite.Particle.Shaders
{
    public sealed class SpriteProgram : Program
    {
        ...
        public ProgramAttribute<float> Progress { get; private set; }

        public ProgramUniform<Texture2D> Texture { get; private set; }
        public ProgramUniform<Texture2D> Texture2 { get; private set; }
                ...
                )
        {
            ...
            Texture = GetUniform<Texture2D>("texture", GL.TEXTURE0);
            Texture2 = GetUniform<Texture2D>("texture2", GL.TEXTURE1);
