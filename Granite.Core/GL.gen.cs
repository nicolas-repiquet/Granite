...
namespace Granite.Core
{
	public partial class GL : OpenGLContext
	{
		...
		private void DeleteTextures(int n, System.IntPtr textures)
		{
		...
		private void DeleteTextures(int n, ref uint textures)
		{
		...
		private void GenTextures(int n, System.IntPtr textures)
		{
		...
		private void GenTextures(int n, out uint textures)
		{
